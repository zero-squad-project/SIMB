                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="" type="text" name="id"
                                                placeholder="Masukkan ID Barang" value="<?= $barang->idBarang ?>"
                                                required>
                                            <?= form_error('nama') ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required class="form-control" aria-required="true" id="select1" name="kategori">
                                                ...
                                                if(!empty($kategori)){ 
                                                    ...
                                                    <option value="<?=$cat['id']?>" <?php if($cat['id'] == $barang->idKategori){ echo "selected"; } ?>><?=$cat['name']?></option>
                                                <?php }
                                                } ?>
                                            </select>
                                            <!-- <span class="help-block">Please enter your email</span> -->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="" type="number" name="min_stok"
                                                ...
                                                value="<?= $barang->stok_min ?>" required>
                                            <?= form_error('min_stok') ?>
                                            <!-- <span class="help-block">Please enter your email</span> -->
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" id="" type="text" name="ket"
                                                ...
                                                required><?= $barang->keterangan ?></textarea>
