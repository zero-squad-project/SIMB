            ...
            <tbody>
                ...
                if ($penjualan != null) {
                    foreach ($penjualan as $key) {
                        ...
                        <?php
                        $biaya += $key['total'];
                        $biayaPen += $key['jumlah'] * $key['harga'];
                    }
                    $pemasukan = $biaya - $biayaPen;
                } else {
                    ?>
                    <tr>
                        <td colspan=5>
                ...
                <tr>
                    <td colspan=4>
                        <p style="text-align:right"><b>Total Penjualan</b></p>
                    </td>
                    <td>
                        <p><?php
                            echo "Rp " .  number_format($biaya) ?></p>
                    </td>
                </tr>
                <tr>
                    <td colspan=4>
                        <p style="text-align:right"><b>Total Pengeluaran</b></p>
                    </td>
                    <td>
                        <p><?php echo "Rp " . number_format($biayaPen) ?></p>
                    </td>
                </tr>
                <tr>
                    <td colspan=4>
                        <p style="text-align:right"><b>Pemasukan Hari ini</b></p>
                    </td>
                    <td>
                        <p><?php echo "Rp " . number_format($pemasukan) ?></p>
                    </td>
                </tr>
            </tbody>
        </table>
