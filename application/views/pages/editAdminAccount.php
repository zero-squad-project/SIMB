                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="<?php echo base_url('adminAccount/index') ?>"><i
                                        class="nav-icon fa fa-arrow-left"></i> Back </a>
                            </div>
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="" type="text" name="username"
                                            ...
                                            value="<?php echo $adminAccount->username; ?>">
                                        <?= form_error('nama') ?>
                                        <!-- <span class="help-block">Please enter your email</span> -->
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-email">Email</label>
                                        <input class="form-control" id="" type="text-area" name="email"
                                            placeholder="Enter Email.." value="<?php echo $adminAccount->email; ?>">
                            ...
                            <div class="card-footer">
                                ...
                                <input class="btn btn-sm btn-danger" type="reset" name="reset">
                                <!-- <i class="fa fa-ban"></i> -->
                            </div>
                            </form>
                        </div>
