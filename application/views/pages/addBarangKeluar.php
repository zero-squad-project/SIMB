                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php echo base_url('transaksi/barang_keluar') ?>"><i class="nav-icon fa fa-arrow-left"></i>
                                Kembali</a>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label for="nf-email">Tanggal Keluar</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="" type="number" name="harga" placeholder="Masukkan harga jual produk" value="<?= set_value('harga') ?>" required>
                                            <?= form_error('harga') ?>
                                            <!-- <span class="help-block">Please enter your email</span> -->
                                        </div>
                                    </div>
